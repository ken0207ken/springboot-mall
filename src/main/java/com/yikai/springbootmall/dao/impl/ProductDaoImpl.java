...
import com.yikai.springbootmall.rowmapper.ProductRowMapper;
...
public class ProductDaoImpl implements ProductDao {
    ...
    public Integer countProduct(ProductQueryParams productQueryParams) {
        ...
        //查詢條件
        sql = addFilterInSql(sql, map, productQueryParams);
    ...
    private String addFilterInSql(String sql, Map<String,Object> map, ProductQueryParams productQueryParams){
